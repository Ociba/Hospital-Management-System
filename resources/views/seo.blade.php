...
<head>
    ...
    <script src="{{ asset('asset/upload/aedemodir/bootstrap5/js/chart.min.js')}}">
    </script>
            ...
            <li class="nav-item sign_box dropdown">
                <a class="nav-link dropdown-toggle text-white  border-0" data-bs-toggle="dropdown" href="#"
                    role="button" aria-expanded="false"><img alt="abc" class="rounded-circle" width="30" height="30"
                        src="{{ asset('asset/upload/aedemodir/img/bac.jpg')}}">Eget
                    Nulla</a>
                ...
                <div class="position-sticky">
                    ...
                    <ul class="nav flex-column mb-2 list-unstyled ps-0">
                        ...
                        <li class="nav-item">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#orders-collapse" aria-expanded="false"><i
                                    class="fa fa-shopping-cart icon-before"></i><span class="btn">Ecommerce</span><i
                                ...
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/ecommerce_prod.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    ...
                                                    class="fa fa-circle-o"></i> Product</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/ecommerce_prod_details.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Product Details</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/ecommerce_orders.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Order</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/ecommerce_orders_detail.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Order Details</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/ecommerce_customers.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Customers</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/ecommerce_sellers.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Sellers</span></a></li>

                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/cart.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Shopping Cart</span></a></li>

                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/checkout.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Checkout</span></a></li>

                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/billing.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Billing</span></a></li>

                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/invoice.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Invoice</span></a></li>

                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/pricing.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Pricing</span></a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#account-collapse" aria-expanded="false"><i
                                    class="fa fa-briefcase icon-before"></i><span class="btn">Projects</span><i
                                    class="fa fa-chevron-right"></i></a>
                            <div class="collapse" id="account-collapse" style="">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/project_list.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Lists</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/project_list_detail.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Details</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/create_project.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Create Project</span></a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#Authent-collapse" aria-expanded="false"><i
                                    class="fa fa-lock icon-before"></i><span class="btn">Authentication</span><i
                                    class="fa fa-chevron-right"></i></a>
                            <div class="collapse" id="Authent-collapse" style="">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a target="_blank"
                                            ...
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Login</span></a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_logout.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Logout</span></a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_register.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Register</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_forgot.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Forgot Password</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_confirm_mail.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Confirm Mail</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_reset_pass.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Reset Password</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_error.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Error</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_card_login.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Card Login</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_card_logout.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Card Logout</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_card_register.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Card Register</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_card_forgot.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Card Forgot</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_card_confirm_mail.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Card Confirm Mail</span></a></li>

                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authent_card_reset_pass.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Card Reset Pass</span></a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#pages-collapse" aria-expanded="false"><i
                                    class="fa fa-copy icon-before"></i><span class="btn">Pages</span><i
                                    class="fa fa-chevron-right"></i></a>
                            <div class="collapse" id="pages-collapse" style="">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/profile.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Profile</span></a></li>
                                    <li><a target="_blank"
                                    ...
                                    <li><a target="_blank"
                                            ...
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Login 2</span></a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/error.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Error</span></a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authen_register.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Register</span></a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authen_logout.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Logout</span></a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authen_recover.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Recover Password</span> </a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authen_lock_screen.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Lock Screen</span></a></li>
                                    <li><a target="_blank"
                                            href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/authen_confirm_mail.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Confirm Mail</span> </a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#base-collapse" aria-expanded="false"><i
                                    class="fa fa-diamond icon-before"></i><span class="btn">Base UI</span><i
                                    class="fa fa-chevron-right"></i></a>
                            <div class="collapse" id="base-collapse" style="">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_accordions.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Accordions</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_alerts.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Alerts</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_badges.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Badges</span> </a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_breadcrumb.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Breadcrumb</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_buttons.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Buttons</span> </a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_card.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Cards</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_carousel.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Carousel</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_dropdown.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Dropdowns</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_grid.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Grid</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_listgroup.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> List Group</span> </a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_modals.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Modals</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_notifi.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Notifications</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_offcanvas.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Offcanvas</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_placeh.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Placeholders</span> </a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_pagination.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Pagination</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_progress.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Progress</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_spinners.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Spinners</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_tabs.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Tabs</span> </a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_tooltips.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Tooltips</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/base_typo.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Typography </span></a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a href="javascript:void(0);"
                                ...
                                data-bs-toggle="collapse" data-bs-target="#Forms-collapse" aria-expanded="false"><i
                                    class="fa fa-file icon-before"></i><span class="btn">Forms</span><i
                                    class="fa fa-chevron-right"></i></a>
                            <div class="collapse" id="Forms-collapse" style="">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/form_basic.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Basic Elements</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/form_validation.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Validation</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/form_wizard.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Wizard</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/form.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i>Wordpress Form</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/list.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i>Wordpress List</span></a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <a href="javascript:void(0);"
                                class="btn btn-toggle align-items-center rounded collapsed w-100 tag_m"
                                data-bs-toggle="collapse" data-bs-target="#table-collapse" aria-expanded="false"><i
                                    class="fa fa-table icon-before"></i><span class="btn">Table</span><i
                                    class="fa fa-chevron-right"></i></a>
                            <div class="collapse" id="table-collapse" style="">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/table_basic.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Basic Table</span></a></li>
                                    <li><a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/table_tow.html')}}"
                                            class="link-dark rounded w-100"><span><i
                                                    style="font-size:8px; vertical-align:middle; margin-right:10px;"
                                                    class="fa fa-circle-o"></i> Tow Table</span></a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/chat.html')}}"
                                class="btn btn-toggle align-items-center rounded w-100 tag_m  no_drop"><i
                                    class="fa fa-comment-o icon-before"></i><span class="btn">Chat</span></a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/chart_chartjs.html')}}"
                                class="btn btn-toggle align-items-center rounded w-100 tag_m  no_drop"><i
                                    class="fa fa-bar-chart icon-before"></i><span class="btn">Charts</span></a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ asset('asset/upload/aedemodir/950a4152c2b4aa3ad78bdd6b366cc179/email.html')}}"
                                class="btn btn-toggle align-items-center rounded w-100 tag_m  no_drop"><i
                                    class="fa fa-envelope icon-before"></i><span class="btn">Email</span></a>
                        </li>
                    </ul>
